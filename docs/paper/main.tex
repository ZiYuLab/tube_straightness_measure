...
对$\mathbf{C}$做特征值分解，特征值排序$\lambda_1 \ge \lambda_2 \ge \lambda_3 \ge 0$，对应单位特征向量$\mathbf{e}_1, \mathbf{e}_2, \mathbf{e}_3$\cite{wpca}。其中$\mathbf{e}_1$为轴线方向，$\mathbf{e}_2$为主弯曲方向。
